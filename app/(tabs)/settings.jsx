...
const Settings = () => {
  ...
  const { translationLanguage, setTranslationLanguage } = useQuranTranslationStore();
  ...
  return (
      ...
      showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.section}>
          <View style={styles.sectionHeader}>
            <View style={styles.sectionIconWrap}>
              <IconButton icon="translate" size={22} color={theme.colors.primary} style={styles.sectionIcon} />
            </View>
          ...
          <View style={[styles.card, styles.cardGradient]}> 
            <View style={styles.cardHeader}>
              <IconButton icon="earth" size={18} color={theme.colors.primary} style={styles.cardIcon} />
            ...
            <Pressable
              ...
              style={({ pressed }) => [styles.selector, { backgroundColor: theme.colors.background }, pressed && styles.selectorPressed]}
            >
              <Text style={[styles.selectorText, { color: theme.colors.textColor }]}> 
                {appLanguages.find((lang) => lang.value === i18n.language)?.label || "English"}
              </Text>
          ...
          <View style={[styles.card, styles.cardGradient]}> 
            <View style={styles.cardHeader}>
              <IconButton icon="book-open-variant" size={18} color={theme.colors.primary} style={styles.cardIcon} />
              <Text style={[styles.title, { color: theme.colors.textColor }]}> 
                {t("Quran Translation")}
              </Text>
            </View>
            ...
            >
              <Text style={[styles.selectorText, { color: theme.colors.textColor }]}> 
                {quranLanguages.find((lang) => lang.value === translationLanguage)?.label || "English"}
              </Text>
              <IconButton icon="chevron-right" size={20} />
            </Pressable>
          </View>
        ...
        <View style={styles.section}>
          <View style={styles.sectionHeader}>
            <View style={styles.sectionIconWrap}>
              <IconButton icon="palette" size={22} color={theme.colors.primary} style={styles.sectionIcon} />
            </View>
            <Text style={[styles.sectionTitle, { color: theme.colors.textColor }]}> 
              {t("Appearance")}
            </Text>
          ...
          <View style={[styles.card, styles.cardGradient]}> 
            <View style={styles.cardHeader}>
              <IconButton icon="theme-light-dark" size={18} color={theme.colors.primary} style={styles.cardIcon} />
              <Text style={[styles.title, { color: theme.colors.textColor }]}> 
                {t("Theme")}
              </Text>
            </View>
